    ...
    if (success) {
        return (
            <AuroraBackground className="min-h-screen flex items-center justify-center p-4">
                <NetworkBackground />
                <div className="relative z-10 w-full max-w-md bg-slate-950/50 backdrop-blur-xl border border-slate-800 rounded-2xl p-8 shadow-2xl text-center">
                    <div className="p-3 bg-green-500/10 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4">
                    ...
                    <Link
                        href="/login"
                        className="block w-full py-2.5 bg-slate-800 hover:bg-slate-700 text-white font-medium rounded-lg transition-colors"
                    >
                        Back to Login
                    </Link>
                </div>
        ...
        <AuroraBackground className="min-h-screen flex items-center justify-center p-4">
            ...
            <div className="relative z-10 w-full max-w-md bg-slate-950/50 backdrop-blur-xl border border-slate-800 rounded-2xl p-8 shadow-2xl">
                <div className="flex flex-col items-center mb-8">
                    ...
                    <p className="text-slate-400">Join the WellSync AI network</p>
                </div>
